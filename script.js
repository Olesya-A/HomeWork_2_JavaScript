...
let num3 = prompt("Введите положительное целое число");
const units = parseInt(num3 % 10);
num3 = num3 / 10;
const tens = parseInt(num3 % 10);
num3 = num3 / 10;
const hundreds = parseInt(num3 % 10);
num3 = num3 * 100;
alert(
  `В числе ${num3} количество сотен: ${hundreds}, десятков: ${tens}, единиц: ${units}`
);
